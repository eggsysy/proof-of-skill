...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  // FIXED: Initialize as false and detect in useEffect to avoid "window is not defined"
  ...
  useEffect(() => {
    // 1. Browser-only detection logic
    ...
    const checkMobile = (hasTouchScreen && isSmallScreen) || isMobileUserAgent;
    setIsMobileDevice(checkMobile);

    if (checkMobile || !cursorRef.current) return;

    // ... Rest of your existing GSAP logic stays exactly the same ...
